...
public class GameBoardController {
    ...
    private void startGame(ActionEvent event)
    {
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long l) {
                ...
                // Update the alien position and draw it
    ...
    {
        if (activeKeys.contains(KeyCode.DOWN) || activeKeys.contains("S"))
            ship.moveDown();
        if (activeKeys.contains(KeyCode.UP) || activeKeys.contains("W"))
            ship.moveUp();
        if (activeKeys.contains(KeyCode.RIGHT) || activeKeys.contains("D"))
            ship.moveRight();
        if (activeKeys.contains(KeyCode.LEFT) || activeKeys.contains("A"))
            ship.moveLeft();
